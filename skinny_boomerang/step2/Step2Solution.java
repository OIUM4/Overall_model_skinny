...
public class Step2Solution {
  ...
  public int[][][] proba;
  /** Eb-last round SBox input differences (null / all-zeros when nExtbRounds == 0). */
  public int[][] dXupper_EbLast;
  /** Eb-last round SBox output differences — the concrete green region (null when nExtbRounds == 0). */
  public int[][] dSBupper_EbLast;
  /** Eb-last round combined TK difference (rows 0-1 only; null when nExtbRounds==0 or SK regime). */
  public int[][] dTKupper_EbLast;
  /** Index of the Step1 solution this Step2 result was computed from (-1 if unknown). */
  public int step1SolutionIndex = -1;
  /** Objective of the corresponding Step1 solution (-1 if unknown). */
  public int step1Objective = -1;

  public Step2Solution() {} // Needed for Jackson

  public Step2Solution(int nbRounds, int nExtbRounds, int nExtfRounds, double probaExponent,
                       int[][][] dXupper, int[][][] dSBupper, int[][][] dYupper, Step2SolutionTweakey dTKupper,
                       int[][][] dXlower, int[][][] dSBlower, int[][][] dYlower, Step2SolutionTweakey dTKlower,
                       int[][][] proba,
                       int[][] dXupper_EbLast, int[][] dSBupper_EbLast, int[][] dTKupper_EbLast) {
    ...
    this.proba = proba;
    this.dXupper_EbLast  = dXupper_EbLast;
    this.dSBupper_EbLast = dSBupper_EbLast;
    this.dTKupper_EbLast = dTKupper_EbLast;
  }
