...
public class Step1Solution {
  ...
  /*continuous EPS diagnostics*/
  public int EPS;
  /** Upper-phase peak after carrying the lower-phase final score. */
  public int epsilonp;
  /** Lower-phase peak, starting from score zero. */
  public int epsilonc;
  public int T3;
